var cookieconsent = function(e) {
    ...
    function g(e, t) {
        ...
        }(t), n = j.bind(null, i, t), a = function() {
            v(i), i.href && URL.revokeObjectURL(i.href)
        }) : (i = b(t), n = w.bind(null, i), a = function() {
            v(i)
        });
        return n(e),
            function(t) {
    ...
    var n, a, o = function() {
            ...
            return e.appendChild = function(e, t, i) {
                var n, a;
                return void 0 === i && (i = null), n = "string" == typeof e ? document.querySelector(e) : e, a = "string" == typeof t ? document.querySelector(t) : t, "afterbegin" === i ? n.insertAdjacentElement("afterbegin", a) : n.insertAdjacentElement("beforeend", a), !0
        ...
        Z = function() {
            ...
            return e.prototype.readScripts = function() {
                ...
                !0 === o.searchObjectsArray(this.cookieConsent.cookieLevels.cookieLevels, "id", t) ? (this.cookieConsent.log("JavaScript script with valid data-cookie-consent tag found, but not loaded yet:", "info"), this.cookieConsent.log(e, "info"), void 0 === this.scripts[t] && (this.scripts[t] = []), this.scripts[t].push(e)) : this.cookieConsent.log("Invalid cookie-consent tag level for JavaScript script: " + t, "warning")
                ...
                new Promise((function(i, n) {
                    ...
                    var s = function(i) {
                        try {
                            ...
                            s.setAttribute("type", "text/javascript"), s.setAttribute("initial-data-cookie-consent", n.getAttribute("data-cookie-consent")), null !== n.getAttribute("src") && s.setAttribute("src", n.getAttribute("src")), a.reduce((function(e, t) {
                                switch (t.name) {
                            ...
                            }), {}), s.text = n.innerHTML, o.appendChild("head", s), n.parentNode.removeChild(n)
                        } catch (e) {
            ...
            return e.prototype.languageChanged = function() {
                ...
                try {
                    for (var i = K(this.cookieLevels), n = i.next(); !n.done; n = i.next()) {
                        var a = n.value;
                        !this.cookieConsent.ownerNoticeBannerPurposesLevels.includes(a.id) && "strictly-necessary" !== a.id || this.preferenceItems.push({
                            id: a.id,
                            title: a.title,
                ...
                }), null !== this.cookieConsent.ownerWebsitePrivacyPolicyUrl && o.isValidUrl(this.cookieConsent.ownerWebsitePrivacyPolicyUrl) && (this.preferenceItems[this.preferenceItems.length - 1].content = this.preferenceItems[this.preferenceItems.length - 1].content + "<p class='cc-cp-body-content-entry-text'>" + this.cookieConsent.i18n.$t("i18n", "pc_minfo_text_3", this.cookieConsent.ownerWebsitePrivacyPolicyUrl) + "</p>")
            }, e
        }(),
        X = function() {
            function e(e) {
            ...
            return e.prototype.listenToUserButtonToOpenPreferences = function(e) {
                ...
                var i = document.querySelector("#termsfeed-com---preferences-center"),
                    ...
                    s = a[a.length - 1];
                t.cookieConsent.log("preferencesCenterOverlayModal_firstFocusableElement: " + n, "info"), t.cookieConsent.log("preferencesCenterOverlayModal_focusableContent: " + a, "info"), t.cookieConsent.log("preferencesCenterOverlayModal_lastFocusableElement: " + s, "info"), document.addEventListener("keydown", (function(e) {
                    var i, a;
                    ("Tab" === e.key || 9 === e.keyCode) && (e.shiftKey ? document.activeElement === n && (t.cookieConsent.log("preferencesCenterOverlayModal_lastFocusableElement before focus: " + s, "info"), null === (i = s) || void 0 === i || i.focus(), e.preventDefault()) : document.activeElement === s && (t.cookieConsent.log("preferencesCenterOverlayModal_firstFocusableElement before focus: " + n, "info"), null === (a = n) || void 0 === a || a.focus(), e.preventDefault()))
                ...
                })), o.appendChild(a, s), o.appendChild(a, l), !1 === e.cookieConsent.ownerPreferencesCenterCloseButtonHide && o.appendChild(l, u, "afterbegin");
                ...
                return e.cookieConsent.cookieLevels.preferenceItems.forEach((function(n) {
                    var a = document.createElement("div");
                    if (a.classList.add("cc-cp-body-content-entry"), a.setAttribute("id", n.content_container), a.setAttribute("role", "tabpanel"), a.setAttribute("aria-labelledby", n.title_container), a.setAttribute("hidden", ""), a.setAttribute("tabindex", "0"), a.setAttribute("content_layout", n.content_container), a.setAttribute("active", "false"), a.innerHTML = n.content, 0 === i && (a.setAttribute("active", "true"), a.removeAttribute("hidden")), i++, n.id) {
                ...
                return e.cookieConsent.cookieLevels.preferenceItems.forEach((function(n) {
                    ...
                    s.classList.add("cc-cp-body-tabs-item-link"), s.setAttribute("id", n.title_container), s.setAttribute("role", "tab"), s.setAttribute("aria-selected", "false"), s.setAttribute("aria-controls", n.content_container), s.setAttribute("tabindex", "-1"), s.setAttribute("t", n.content_container), s.innerHTML = n.title, 0 === i && (a.setAttribute("active", "true"), s.setAttribute("aria-selected", "true"), s.setAttribute("tabindex", "0")), i++, s.addEventListener("click", (function(t) {
                        t.preventDefault(), e.cookieConsent.log("Preferences Center tab item clicked: " + n.title, "info");
                        var i = document.querySelectorAll('li[active="true"]');
                        [].forEach.call(i, (function(e) {
                            e.setAttribute("active", "false"), e.firstElementChild.setAttribute("aria-selected", "false"), e.firstElementChild.setAttribute("tabindex", "-1")
                        })), a.setAttribute("active", "true"), a.firstElementChild.setAttribute("aria-selected", "true"), a.firstElementChild.setAttribute("tabindex", "0");
                        try {
                    ...
                    })), o.appendChild(a, s), o.appendChild(t, a)
                })), t
                ...
                var i = document.createElement("div");
                i.classList.add("cc-cp-foot-byline"), i.innerHTML = "Cookie Consent";
                var n = document.createElement("div");
                n.classList.add("cc-cp-foot-button");
                var a = document.createElement("button");
                return a.classList.add("cc-cp-foot-save"), a.innerHTML = e.cookieConsent.i18n.$t("i18n", "pc_save"), a.addEventListener("click", (function() {
                    document.dispatchEvent(e.cookieConsent.events.cc_preferencesCenterSavePressed)
                })), o.appendChild(n, a), o.appendChild(t, i), o.appendChild(t, n), t
                ...
                if (i.classList.add("cc-custom-checkbox"), "strictly-necessary" !== e.id) {
                    ...
                    a.setAttribute("cookie_consent_toggler", "true"), a.setAttribute("type", "checkbox"), a.setAttribute("class", "cc-custom-checkbox"), a.setAttribute("id", e.id), a.setAttribute("name", e.id), a.setAttribute("aria-labelledby", e.id + "_label"), (s = document.createElement("label")).setAttribute("for", e.id), s.setAttribute("id", e.id + "_label"), n[e.id] ? (a.setAttribute("checked", "checked"), a.setAttribute("aria-checked", "true"), s.setAttribute("class", "is-active"), s.innerHTML = t.cookieConsent.i18n.$t("i18n", "active")) : (a.setAttribute("aria-checked", "false"), s.setAttribute("class", "is-inactive"), s.innerHTML = t.cookieConsent.i18n.$t("i18n", "inactive")), a.addEventListener("change", (function() {
                        var i = a.checked,
                            n = e.id,
                            o = document.querySelector('label[for="' + n + '"]');
                        t.cookieConsent.log("User changed cookie level [" + n + "], new status: " + i, "info"), document.dispatchEvent(t.cookieConsent.events.cc_userChangedConsent), !0 === i ? (t.cookieConsent.userConsent.acceptLevel(n, !1), o.innerHTML = t.cookieConsent.i18n.$t("i18n", "active")) : (t.cookieConsent.userConsent.rejectLevel(n, !1), o.innerHTML = t.cookieConsent.i18n.$t("i18n", "inactive"))
                    })), a.addEventListener("keypress", (function(e) {
                        if (" " === e.key || "Spacebar" === e.key) switch (a.getAttribute("aria-checked")) {
                            case "true":
                    ...
                    })), o.appendChild(i, a), o.appendChild(i, s)
                } else {
        ...
        ee = function() {
            ...
            return e.prototype.initNoticeBanner = function() {
                var e, t;
                if (null === this.noticeBanner && (this.noticeBanner = this.createNoticeBanner()), t = "afterbegin" === this.cookieConsent.ownerNoticeBannerAppendContentPosition || "beforeend" === this.cookieConsent.ownerNoticeBannerAppendContentPosition ? this.cookieConsent.ownerNoticeBannerAppendContentPosition : "afterbegin", o.appendChild("body", this.noticeBanner, t), this.cookieConsent.log("Notice Banner shown " + t, "info"), document.dispatchEvent(this.cookieConsent.events.cc_noticeBannerShown), "interstitial" === this.cookieConsent.ownerNoticeBannerType || "standalone" === this.cookieConsent.ownerNoticeBannerType) {
                ...
                d.classList.add("cc-nb-text-urls-separator"), d.innerHTML = " | ", e.cookieConsent.noticeBannerInsertLegalUrls && (e.cookieConsent.ownerWebsitePrivacyPolicyUrl && e.cookieConsent.ownerWebsiteImpressumUrl ? o.isValidUrl(e.cookieConsent.ownerWebsitePrivacyPolicyUrl) && o.isValidUrl(e.cookieConsent.ownerWebsiteImpressumUrl) && (p.innerHTML = e.cookieConsent.i18n.$t("i18n", "privacy_policy", e.cookieConsent.ownerWebsitePrivacyPolicyUrl), u.innerHTML = e.cookieConsent.i18n.$t("i18n", "impressum", e.cookieConsent.ownerWebsiteImpressumUrl), o.appendChild(l, p), o.appendChild(p, d), o.appendChild(l, u)) : e.cookieConsent.ownerWebsitePrivacyPolicyUrl && o.isValidUrl(e.cookieConsent.ownerWebsitePrivacyPolicyUrl) ? (p.innerHTML = e.cookieConsent.i18n.$t("i18n", "privacy_policy", e.cookieConsent.ownerWebsitePrivacyPolicyUrl), o.appendChild(l, p)) : e.cookieConsent.ownerWebsiteImpressumUrl && o.isValidUrl(e.cookieConsent.ownerWebsiteImpressumUrl) && (u.innerHTML = e.cookieConsent.i18n.$t("i18n", "impressum", e.cookieConsent.ownerWebsiteImpressumUrl), o.appendChild(l, u)), o.appendChild(s, l)), o.appendChild(a, s);
                var _ = document.createElement("div");
                _.classList.add("cc-nb-buttons-container");
                var m = document.createElement("button");
                m.classList.add("cc-nb-okagree"), m.setAttribute("role", "button"), "express" == e.cookieConsent.ownerConsentType ? m.innerHTML = e.cookieConsent.i18n.$t("i18n", "nb_agree") : m.innerHTML = e.cookieConsent.i18n.$t("i18n", "nb_ok"), m.addEventListener("click", (function() {
                    document.dispatchEvent(e.cookieConsent.events.cc_noticeBannerOkOrAgreePressed)
                })), o.appendChild(_, m);
                var k = document.createElement("button");
                k.classList.add("cc-nb-reject"), k.setAttribute("role", "button"), k.innerHTML = e.cookieConsent.i18n.$t("i18n", "nb_reject"), k.addEventListener("click", (function() {
                ...
                return v.classList.add("cc-nb-changep"), v.setAttribute("role", "button"), v.innerHTML = e.cookieConsent.i18n.$t("i18n", "nb_changep"), v.addEventListener("click", (function() {
                    document.dispatchEvent(e.cookieConsent.events.cc_noticeBannerChangePreferencesPressed)
                })), o.appendChild(_, v), o.appendChild(t, i), o.appendChild(t, a), o.appendChild(t, _), t
            }, e
        }(),
        te = function(e) {
            function t(t) {
        ...
        _e = function(e) {
            return a = new de(e), window.cookieconsent.openPreferencesCenter = function() {
