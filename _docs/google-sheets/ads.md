...
- (Opzionale) Il Web App invia un'email di ringraziamento usando il template `_docs/email-templates/ads-email-thank-you.html`
...
2. Copia il contenuto del file del repository `_docs/email-templates/ads-email-thank-you.html` e incollalo nel file HTML di Apps Script
